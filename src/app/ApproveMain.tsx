...
export default function Fullmap() {
  return (
    <SafeAreaView>
      <ScrollView>
        <View style={{ padding: 20, margin: 15, backgroundColor: "pink" }}>
          <View
            style={[
              styles.container,
              {
          ...
          <View style={[styles.container, {alignItems:"flex-end"}]}>
                <View style={{flexDirection: "row", margin: 10}}>
                  <Button style={{color: "white",marginRight: 10, backgroundColor: "green"}} size="$3" theme="active">Approve</Button>
                  <Button style={{color: "white",backgroundColor: "red"}} size="$3" theme="active">Deny</Button>
                </View>
          </View>
        </View>
      </ScrollView>
