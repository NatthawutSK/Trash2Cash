        ...
        <Stack
          ...
          onPress={() => {
            router.push({
              ...
              params: {
                img: data[1].img || "https://picsum.photos/200/300",
          ...
          <View jc={"center"} ai={"center"} mb={10}>
            <Avatar als={"center"} circular size={"$7"}>
              <Avatar.Image
                ...
                src={
                  data[1].img ? data[1].img : "https://picsum.photos/300/300"
                }
              />
        ...
        <Stack
          ...
          onPress={() => {
            router.push({
              pathname: `/profileRanking/${data[1].auth_id}`,
              params: {
                img: data[0].img || "https://picsum.photos/200/300",
          ...
          <View jc={"center"} ai={"center"} mb={10}>
            <Avatar als={"center"} circular size={"$7"}>
              <Avatar.Image
                accessibilityLabel="Cam"
                src={
                  data[0].img ? data[0].img : "https://picsum.photos/200/300"
                }
              />
        ...
        <Stack
          ...
          onPress={() => {
            router.push({
              pathname: `/profileRanking/${data[1].auth_id}`,
              params: {
                img: data[2].img || "https://picsum.photos/200/300",
        ...
        >
          <View jc={"center"} ai={"center"} mb={10}>
            <Avatar als={"center"} circular size={"$7"}>
              <Avatar.Image
                accessibilityLabel="Cam"
                src={data[2].img || "https://picsum.photos/300/300"}
              />
